#!/usr/bin/env python3
"""Module fotegration tests for `app.py`.
"""
...
def log_in_wrong_password(email: str, password: str) -> None:
    """Test lo wrong password.

    Args:
        email (str): user to log in.
...
def profile_logged(session_id: str) -> None:
    """ information whilst logged in.

    Args:
        session_id (str): the logged in user.
    """
...
def reset_password_token(email: str) -> str:
    ...
    Args:
        email (str): request password reset for.
    """
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    ...
    Args:
        email (str): The ema updated.
        reset_token (str): The  the user.
        new_password (str): The net for the user.
    """
    url = "{}/reset_password".format(BASE_URL)
    data = {
        "email": email,
